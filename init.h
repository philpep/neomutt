...
struct ConfigDef MuttVars[] = {
  ...
  */
  ...
  { "edit_hdrs",              DT_SYNONYM, R_NONE, "edit_headers",             0 },
  { "envelope_from",          DT_SYNONYM, R_NONE, "use_envelope_from",        0 },
  { "forw_decode",            DT_SYNONYM, R_NONE, "forward_decode",           0 },
  { "forw_decrypt",           DT_SYNONYM, R_NONE, "forward_decrypt",          0 },
  { "forw_format",            DT_SYNONYM, R_NONE, "forward_format",           0 },
  { "forw_quote",             DT_SYNONYM, R_NONE, "forward_quote",            0 },
  { "hdr_format",             DT_SYNONYM, R_NONE, "index_format",             0 },
  { "indent_str",             DT_SYNONYM, R_NONE, "indent_string",            0 },
  { "mime_fwd",               DT_SYNONYM, R_NONE, "mime_forward",             0 },
  { "msg_format",             DT_SYNONYM, R_NONE, "message_format",           0 },
  { "pgp_autoencrypt",        DT_SYNONYM, R_NONE, "crypt_autoencrypt",        0 },
  { "pgp_autosign",           DT_SYNONYM, R_NONE, "crypt_autosign",           0 },
  { "pgp_auto_traditional",   DT_SYNONYM, R_NONE, "pgp_replyinline",          0 },
  { "pgp_create_traditional", DT_SYNONYM, R_NONE, "pgp_autoinline",           0 },
  { "pgp_replyencrypt",       DT_SYNONYM, R_NONE, "crypt_replyencrypt",       0 },
  { "pgp_replysign",          DT_SYNONYM, R_NONE, "crypt_replysign",          0 },
  { "pgp_replysignencrypted", DT_SYNONYM, R_NONE, "crypt_replysignencrypted", 0 },
  { "pgp_verify_sig",         DT_SYNONYM, R_NONE, "crypt_verify_sig",         0 },
  { "post_indent_str",        DT_SYNONYM, R_NONE, "post_indent_string",       0 },
  { "print_cmd",              DT_SYNONYM, R_NONE, "print_command",            0 },
  { "smime_sign_as",          DT_SYNONYM, R_NONE, "smime_default_key",        0 },
  { "xterm_icon",             DT_SYNONYM, R_NONE, "ts_icon_format",           0 },
  { "xterm_set_titles",       DT_SYNONYM, R_NONE, "ts_enabled",               0 },
  { "xterm_title",            DT_SYNONYM, R_NONE, "ts_status_format",         0 },
  { NULL, 0, 0, 0, 0 },
};
